...
saveDir <- "C:/Users/ouz001/working_from_home_post_Sep2022/sandy_soils_output1_app/Pre_processing/6.Crystal_Brook_Randals/preprocessing_output"
...
##JACKIE
zones.sf <- st_read(paste0(readDir,"/3.Covariates/6.Clusters_Zones/FINAL/RAN_z3ones_soil.shp"))
