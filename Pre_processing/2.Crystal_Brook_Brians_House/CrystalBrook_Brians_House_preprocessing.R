...
trial.plan <- suppressMessages(st_read(file.path(readDir, "5.Trial_Plan/FINAL-Trial-Plan/GIS/BHO_PlotsStrips_Trial-Layout_MASK_trimmed_epsg4326.shp"), quiet = TRUE))
